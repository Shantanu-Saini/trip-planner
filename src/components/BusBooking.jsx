...
export default function BusBooking({ city }) {
    const [fromCity, setFromCity] = useState("");
    const [passengerCount, setPassengerCount] = useState(1);
    const [passengers, setPassengers] = useState([{ name: "", age: "" }]);
    const [date, setDate] = useState("");
    const [busClass, setBusClass] = useState("AC");
    ...
    return (
        <div className="min-h-screen w-full bg-gray-100 p-8">
            <div className="max-w-full mx-auto bg-white p-8 rounded shadow">
                <h1 className="text-3xl font-bold text-center mb-6">Book Your Bus</h1>
                ...
                <form className="space-y-4" onSubmit={handleSubmit}>
                    ...
                    <div>
                        <label className="block text-gray-700">Bus Class</label>
                        <div className="flex items-center space-x-4">
                            ...
                            <label className="flex items-center">
                                <input
                                    ...
                                    name="busClass"
                                    value="Semi-Sleeper"
                                    checked={busClass === "Semi-Sleeper"}
                                    onChange={(e) => setBusClass(e.target.value)}
                                />
                                <span className="ml-2">Semi-Sleeper</span>
                            </label>
                        </div>
                    </div>
